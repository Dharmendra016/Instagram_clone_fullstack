...
const CommentDialog = ({ open, setOpen }) => {
    ...
    const sendMessageHandler = async () => {
        ...
        try {
            ...
            const res = await axios.post(`https://instagram-clone-fullstack-ey08.onrender.com/api/v1/post/${selectedPost._id}/comment`, { text }, {
                headers: {
        ...
        <Dialog open={open}>
            <DialogContent onInteractOutside={() => setOpen(false)}
                ...
                <div className='flex flex-1'>
                    <div className='w-1/2'>
                        <img className='w-full h-full object-cover rounded-l-lg' src={selectedPost?.image} alt="Image" />
                    ...
                    <div className='w-1/2 flex flex-col justify-between ' >
                        <div className='flex items-center justify-between p-4'>
                            <div className='flex items-center gap-3 justify-center'>
                                <Link>
                                    <Avatar>
                                        <AvatarImage src={selectedPost?.author.profilePic} className='h-8 w-8 object-cover rounded-full ' />
